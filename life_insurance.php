...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO lifeinsurance_services (fullName, dob, gender, maritalstatus, address, phonenumber, emailad, 
...
if ($conn->query($sql) === TRUE) {
    ...
    echo '<h2 style="color: #ff8400; font-family: "Arial", sans-serif;">LIFE INSURANCE APPLICATION SUBMITTED SUCCESSFULLY!</h2>';
